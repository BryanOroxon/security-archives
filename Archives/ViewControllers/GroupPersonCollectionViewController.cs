...
namespace Archives.ViewControllers
{
	public partial class GroupPersonCollectionViewController : UICollectionViewController
	{
		...
		async Task loadPeople()
		{
			try
			{
				await PersonClient.Shared.ListPersonsInPersonGroup(Group);

				foreach (var person in Group.People)
				{
					await PersonClient.Shared.GetPersonFaces(person, Group);
				}
			...
			if (gestureRecognizer.State == UIGestureRecognizerState.Began)
			{
				try
				{
					...
					if (result == "Yes")
					{
						...
						await PersonClient.Shared.DeletePerson(person, Group);
